        ...
        <div id="page-contents">
          <div class="row">
            ...
            <div class="col-md-7">
              ...
              <!-- Post Create Box
              ================================================= -->
              <?php include 'postcreateprofile.php' ?><!-- Post Create Box End-->
            ...
            <div style="margin-top: -3%" class="post-content">
              <div class="post-date hidden-xs hidden-sm">
                  <h5><?php $postUs=$postcek['user_id']; 
                      ...
                      ?></h5>
                  <a href="<?=$postcek['link']; ?>/post"><p class="text-grey">
<?php
...
<script type="text/javascript" src="a\b\c\d\e\f\g\a\custom7.js">
