    	...
    	<div class="container">
          ...
          ================================================= -->
            ...
            <div class="create-post">
            	<h4 class="grey">Etiketlendiklerim</h4>
            </div>
            ...
            <div class="media">
                ...
                <div class="grid-item col-md-6 col-sm-6">
                    ...
                    <div class="media-info">
                      <div class="reaction">
                        <a class="btn text-green"><i class="fa fa-thumbs-up"></i> Profilimde Göster</a>
                        <a class="btn text-red"><i class="fa fa-thumbs-down"></i> Profilimde Gösterme</a>
                      </div>
                      <div class="user-info">
                        <img src="images/users/user-8.jpg" alt="" class="profile-photo-sm pull-left" />
                        <div class="user">
                          <h6><a href="#" class="profile-link">Richard Bell</a></h6>
                          <a class="text-green" href="#">Etiketleyen</a>
                        </div>
                      </div>
                    </div>
                          ...
                          <div class="post-content">
                            ...
                            <div class="post-container">
                              ...
                              <div class="post-detail">
                                <div class="user-info">
                                  <h5><a href="timeline.html" class="profile-link">Alexis Clark</a> <span class="following">Takip Ediyorsun</span></h5>
                                  <p class="text-muted">3 dakika önce</p>
                                </div>
                                <div class="reaction">
