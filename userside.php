<div class="col-md-3 static">
            <div class="profile-card">
            	...
            	<h5><a href="timeline.html" class="text-white"><?=$sesCek['name'].' '.$sesCek['surname']; ?></a></h5>
            	<a href="#" class="text-white"><i class="ion ion-android-person-add"></i> 1,299 takipçi</a>
            </div><!--profile card ends-->
            <ul class="nav-news-feed">
              <li><i class="icon ion-ios-paper"></i><div><a href="newsfeed.php">Gönderi Akışı</a></div></li>
              ...
              <li><i class="icon ion-chatboxes"></i><div><a href="messages.php">Mesajlar</a></div></li>
              <li><i class="icon ion-images"></i><div><a href="newsfeed-images.html">Etiketlendiklerim</a></div></li>
              <li><i class="icon ion-ios-videocam"></i><div><a href="newsfeed-videos.html">Videos</a></div></li>
              <li><i class="icon ion-ios-close"></i><div><a href="logout.php">Güvenli Çıkış</a></div></li>
            </ul><!--news-feed links ends-->
            <div id="chat-block">
              <div class="title">Aktif Arkadaşlar</div>
